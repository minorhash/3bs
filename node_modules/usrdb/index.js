...
exports.insPid=function(email,pid,mnt,buy,ite,utc){
var stm=db.prepare('insert into pid values(?,?,?,?,?,?)');
stm.run(email,pid,mnt,buy,ite,utc)
};
...
exports.insPal=function(email,id,ite,utc){
var stm=db.prepare('insert into pal values(?,?,?,?)');

try{stm.run(email,id,ite,utc)}
catch(err){console.log(err)}
};
